...
//
export type TalkLatestItemProps = {
  talk: Talk;
};
// ___________________________________________________________________________
//
export const TalkLatestItem: React.VFC<TalkLatestItemProps> = ({ talk }) => {
  // ___________________________________________________________________________
  //
  return (
    <>
      <div
        key={talk.id}
        className='flex items-center p-4 border-t border-gray-200 first:border-t-0'
      >
